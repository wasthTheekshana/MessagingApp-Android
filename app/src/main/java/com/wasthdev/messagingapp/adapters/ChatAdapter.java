...
import com.wasthdev.messagingapp.databinding.ItemContainerReceviedMessageBinding;
import com.wasthdev.messagingapp.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_SENT) {
            ...
            return new ReceiverMessageViewHolder(
                    ItemContainerReceviedMessageBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false)
            );
        }
    ...
    static class ReceiverMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        public ReceiverMessageViewHolder(ItemContainerReceviedMessageBinding itemContainerReceviedMessageBinding) {
