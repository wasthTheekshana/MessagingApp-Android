...
import com.wasthdev.messagingapp.databinding.ActivitySignUpBinding;
...
private void signUp(){
    ...
    user.put(Constants.KEY_IMAGE,encodingMessage);
    database.collection(Constants.KEY_COLLECTION_USERS)
            ...
            .addOnSuccessListener(documentReference -> {
                ...
                preferenceManager.putString(Constants.KEY_IMAGE, encodingMessage);
      ...
      if (result.getResultCode() == RESULT_OK){
          if (result.getData() != null){
              ...
              try{
                  ...
                  encodingMessage = encodeImage(bitmap);
...
private Boolean isValidSignUpDetails(){
    if (encodingMessage == null){
        ...
        showToast("Check Your Password Correclty");
        return false;
