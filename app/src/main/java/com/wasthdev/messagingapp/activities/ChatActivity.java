...
import com.wasthdev.messagingapp.adapters.ChatAdapter;
import com.wasthdev.messagingapp.databinding.ActivityChatBinding;
        ...
        if (value != null){
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()){
                ...
                if (documentChange.getType() == DocumentChange.Type.ADDED){
                    ...
                    chatMessage.dateTime = readAbleDate(documentChange.getDocument().getDate(Constants.KEY_TIMESTAMP));
